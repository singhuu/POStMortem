...
public class SwipeLevelActivity extends LevelActivity {
    /**
     * Level Object of the Swipe Class
     */
    SwipeLevel level;

    /**
     * Stores the position of obstacle tiles
     */
    ...
    /**
     * Variable that stores whether player is moving or not
     */
     ...
     *
     * @param cTimeInSeconds countdown time left
     */
    ...
    /**
     * Getter method that returns the Obstacle tiles
     *
     * @return the Obstacle tile positions with their updated levels
     */
    ...
    public class SwipeLevelGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        /**
         * Method override since all gestures start with an onDown()
         */
        @Override
